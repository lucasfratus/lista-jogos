# "From my blood, come the prince (or princess) that was promissed, and theirs will be the Song of Ice and Fire" ~ Aegon the Conqueror
# Alunos:
...
def inserir_registro(entrada: io.TextIOWrapper, registro: str):
    ...
    if tam_headLed >= tam_reg: # Se o tamanho da cabeça for maior ou igual ao tamanho do registro a ser inserido, faça:
        ...
        entrada.seek(headLed+2, os.SEEK_SET) # Posiciona o ponteiro após o indicador de tamanho do registro
        ...
        elif tam_sobra > TAM_SOBRA_MIN: # Se o tamanho da sobra for somente maior que 10:
            entrada.seek(headLed, os.SEEK_SET)
            entrada.write(tam_reg.to_bytes(2))
